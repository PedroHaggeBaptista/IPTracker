...
function Card({ mock }) {
  return (
    <div className="flex justify-center sm:mb-32">
      <div className="grid  lg:grid-cols-3 lg:gap-20 md:grid-cols-1 justify-items-center lg:w-100 md:w-90 lg:pl-28">
        {mock.map(element => (
          ...
          >
            <div className="flex  m-4 rounded-md bg-ipt w-32 p-2 text-white items-center justify-center">
              <p className="ml-2 text-xl ">Id: {element.patrimonioId}</p>
            </div>
            ...
            <div className="text-2xl text-center">
              <p>
                ...
                <span>{"Dia " + new Date(element.updated_at).getDate() + " -" +  new Date(element.updated_at).getHours() + ":" +
                new Date(element.updated_at).getMinutes()}</span>
              </p>
            </div>
